...
from schema import interactive_create_schema, interactive_get_schema, get_schema, create_schema
from connections import create_invitation, query_active_connections, interactive_create_invitation, interactive_query_connections
from credential import get_credential_definition, create_credential_definition, issue_credential, send_proposal, interactive_get_credential_definition, interactive_create_credential_definition, interactive_issue_credential, interactive_send_proposal
from messages import send_message, query_messages, interactive_query_messages, interactive_send_message
...
def main():
    ...
    if args.interactive:
        ...
        action_map = {
            'create-schema': lambda: create_schema(args.schema_name, args.schema_version, args.attributes, auth_token=args.auth_token, url=args.url),
            'get-schema': lambda: get_schema(args.schema_id, auth_token=args.auth_token, url=args.url),
            'get-cred-def': lambda: get_credential_definition(args.credential_definition_id, auth_token=args.auth_token, url=args.url),
            'create-cred-def': lambda: create_credential_definition(args.schema_id, args.tag, args.support_revocation, auth_token=args.auth_token, url=args.url),
            'create-invitation': lambda: create_invitation(args.alias, args.auto_accept, args.public, args.multi_use, auth_token=args.auth_token, url=args.url),
            'send-proposal': lambda: send_proposal(args.auto_remove, args.comment, args.connection_id, args.credential_preview, args.filter, args.replacement_id, args.trace, args.verification_method, auth_token=args.auth_token, url=args.url),
            'issue-credential': lambda: issue_credential(args.credential_data_path, auth_token=args.auth_token, url=args.url),
            'query-connections': lambda: query_active_connections(auth_token=args.auth_token, url=args.url),
            'query-messages': lambda: query_messages(args.connection_id, args.state, auth_token=args.auth_token, url=args.url),
            'send-message': lambda: send_message(args.connection_id, args.content, auth_token=args.auth_token, url=args.url),
            'check-status': lambda: check_status(auth_token=args.auth_token, url=args.url)
        }
